  ...
  return (
    <form onSubmit={onSubmit}>
      <TextField label="Comments" id="fullWidth" 
        ...
        value={text}
        style= {{width:"550px", maxWidth: "100%", flex: 1, flexWrap: 'wrap', wordWrap:"break-word", wordBreak:"break-word", overflowWrap:"anywhere", marginLeft:"65px", paddingLeft:"20px", paddingRight:"0px", paddingTop:"5px",marginBottom:"10px", marginTop: "10px", borderRadius:"0.2em", border:"none"}}
